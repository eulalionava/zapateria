...
export const FilterGender = () => {
    ...
    const rangesOfSizes: { [key: string]: string } = {
        all:'',
        men:'Tallas desde 23 hasta 27',
        woman:'Tallas desde 23 hasta 27',
        girl:'Tallas desde 15 hasta 22',
        boy:'Tallas desde 15 hasta 22',
    ...
    return (
        <>
            ...
            <div className="px-3">
                <h1 className="text-gray-400 font-bold">{rangesOfSizes[filterForGender]}</h1>
            </div>
        </>
    )
}
